...
const log = (id: string, breathlessness = 2, soreness = 2): SessionLog => ({ id, date: `2026-08-${id.padStart(2, '0')}`, plan: getTodayPlan(new Date(2026, 7, 17), 1), source: 'program', status: 'completed', completedItemIds: ['march'], skippedItemIds: [], elapsedSeconds: 900, wellness: { energy: 3, soreness, breathlessness }, updatedAt: new Date().toISOString() });
